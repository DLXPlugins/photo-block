	...
	const getSnackBar = () => {
		return (
			<WPSnackBar
				className={
					classnames(
						`dlx-pb-snackbar dlx-pb-snackbar-${ notificationOptions.type }`,
						{
							'dlx-pb-snackbar-loading': isBusy,
						}
					)
				}
		...
		if ( 'critical' === notificationOptions.type ) {
			return (
				<Modal
					className={
						classnames(
							`dlx-pb-modal dlx-pb-modal-${ notificationOptions.type }`,
							{
								'dlx-pb-modal-loading': isBusy,
							}
						)
					}
					bodyOpenClassName={ 'dlx-pb-modal-body-open' }
				...
				>
					<Notice
						...
						inline={ false }
					/>
					<div className="dlx-pb-modal-button-group">
						<Button
