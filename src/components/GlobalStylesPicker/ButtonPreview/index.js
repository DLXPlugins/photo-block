				...
				<Button
					...
					onClick={ () => {
						...
						props.setAttributes( {
							...
							hasCaption,
							imageSize: attributes.imageSizeOverride ? attributes.imageSize : globalStyleObject.content?.photoAttributes?.imageSize || 'full',
							mediaLinkType: attributes.mediaLinkOverride ? attributes.mediaLinkType : globalStyleObject.content?.photoAttributes?.mediaLinkType || 'none',
