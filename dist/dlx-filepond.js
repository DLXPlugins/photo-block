...
/* harmony export */   processSvg: () => (/* binding */ processSvg),
/* harmony export */   redoSvg: () => (/* binding */ redoSvg)
/* harmony export */ });
...
/* harmony import */ var _blocks_photo_block_icons_filepond__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../blocks/photo-block/icons/filepond */ "./src/blocks/photo-block/icons/filepond.js");
...
filepond__WEBPACK_IMPORTED_MODULE_2__.registerPlugin((filepond_plugin_image_preview__WEBPACK_IMPORTED_MODULE_3___default()), (filepond_plugin_image_exif_orientation__WEBPACK_IMPORTED_MODULE_4___default()), (filepond_plugin_file_validate_type__WEBPACK_IMPORTED_MODULE_5___default()));
...
var attachFilepond = function attachFilepond(filepondDocument) {
  ...
  blocks.forEach(function (inputEl) {
    ...
    var setImageData = function setImageData(data) {
      if (!blockUniqueId) {
        return;
      }
    ...
    var pond = filepond__WEBPACK_IMPORTED_MODULE_2__.create(inputEl, {
      ...
      labelFileTypeNotAllowed: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Invalid file type', 'photo-block'),
      labelTapToCancel: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Click to cancel', 'photo-block'),
      imagePreviewMaxFileSize: '4MB',
      iconRetry: _blocks_photo_block_icons_filepond__WEBPACK_IMPORTED_MODULE_8__.redoSvg,
      iconProcess: _blocks_photo_block_icons_filepond__WEBPACK_IMPORTED_MODULE_8__.processSvg,
    ...
    pond.on('processfile', function (error, file) {
      ...
      setIsUploading(false);
      if (file.serverId) {
        var attachmentData = JSON.parse(file.serverId);
...
/******/ })()
;
//# sourceMappingURL=dlx-filepond.js.map